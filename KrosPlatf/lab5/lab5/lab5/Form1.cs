...
namespace lab5
{
    public partial class Form1 : Form
    {
        ...
        public class CaseTransistors
        {
            ...
            transPrefixName[] Prefixs; // Масив для зберігання валідних префіксів імен
                                        //транзисторів
            ...
            {
                // У конструкторі класу створюємо масив для зберігання транзисторів - екземплярів класу
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            CaseTransistors MyTr3 = new CaseTransistors(1, "Schottky", "AC139", "Gummel-Poon");
            CaseTransistors MyTr4 = new CaseTransistors(1, "Avalanche", "AC117", "EbbersMoll");
            ...
            CaseTransistors MyTr8 = new CaseTransistors(1, "Test", "AA727", "TestExample");
            CaseTransistors MyTr9 = new CaseTransistors(10,"TR9", "AD133", "Tr9");
